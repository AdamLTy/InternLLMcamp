...
data = {
    ...
    'content': [
        ...
        'Yes, the codes for DSCNet are publicly available, allowing other researchers and practitioners to access and utilize the method in their own work.',
